...
const search = () => {
    router.get(route("sessions.index", { search: form.search }));
};

const destroy = (session) => {
    router.delete(route("sessions.destroy", session));
};

const restore = (id) => {
    router.put(route("sessions.restore", id));
};
                            ...
                            <div class="sm:flex sm:items-center">
                                <div class="sm:flex-auto">
                                    ...
                                    <p class="mt-2 text-sm text-gray-700">
                                        A list of all the sessions in the
                                        system.
                                    </p>
                                </div>
