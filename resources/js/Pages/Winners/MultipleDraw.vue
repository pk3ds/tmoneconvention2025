...
const startDraw = () => {
    ...
    axios
        .post(route("winners.storeMultiple"), form)
        .then((response) => {
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        class="w-16 text-center text-purple-900 rounded-lg focus:border-light-blue"
                                    />
                                    <button
                                        type="submit"
                                        class="pl-6 text-2xl transition duration-200 text-light-blue"
                                    >
                                        Start Lucky Draw
                                    </button>
                                </form>
        ...
        >
            <div class="pt-4">
                <span>
                    <div class="px-8">
                        <div
                            class="grid items-center justify-center grid-cols-3"
                        >
                            <div
                ...
                <span class="flex justify-center w-full my-12">
                    <div class="px-8">
                            ...
                            <div class="relative group">
                                ...
                                >
                                    <span class="flex items-center space-x-5">
                                        <button
                                            @click="reset"
                                            class="text-2xl transition duration-200 text-light-blue"
                                        >
                                            Reset
                                        </button>
                                    </span>
