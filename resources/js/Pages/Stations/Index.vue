...
const search = () => {
    router.get(route("stations.index", { search: form.search }));
};

const destroy = (group) => {
    router.delete(route("stations.destroy", group));
};
                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                                ...
                                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                    <Link :href="route('stations.create')">
                                        <PrimaryButton>
                                            Add station
                                        </PrimaryButton>
                                    </Link>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <p
                                                                class="text-sm font-bold text-gray-900 ms-2 dark:text-white"
                                                            >
                                                                {{
                                                                    station.rating
                                                                }}
