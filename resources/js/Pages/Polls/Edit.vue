//resources/js/Pages/Polls/Edit.vue
<script setup>
import { ref } from "vue";
...
const form = ref({
    ...
    expires_at: props.poll.expires_at,
    options: props.poll.options.map((option) => option.option_text),
});
...
const submit = () => {
    ...
    router.put(route("polls.update", props.poll), form.value, {
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h2 class="text-2xl font-bold mb-6">Edit Poll</h2>
